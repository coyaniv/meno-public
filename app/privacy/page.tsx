...
export default function PrivacyPolicyPage() {
  return (
    <div style={container}>
      ...
      <h2 style={h2Style} id="cookies">7. עוגיות (Cookies)</h2>
      <p>
        אתר Meno עושה שימוש בעוגיות לצורך מדידה ושיפור חוויית השימוש. בביקור
        ראשון יוצג באנר עוגיות; המשך הגלישה והסרת הבאנר מהווים הסכמה.
      </p>
      <p><strong>סוגי עוגיות:</strong></p>
      <ul>
        <li><strong>עוגיות חיוניות:</strong> נדרשות לתפעול בסיסי של האתר ולשמירת העדפת העוגיות.</li>
        <li><strong>עוגיות אנליטיקה:</strong> נטענות באמצעות Google Analytics לצורך מדידת דפוסי שימוש, מספר מבקרים, דפים נצפים ומשך ביקור — בצורה מצרפית.</li>
      </ul>
      <p>
        ניתן לשנות את בחירתך בכל עת באמצעות כפתור &quot;ניהול העדפות עוגיות&quot;
        בתחתית האתר, או לחסום עוגיות דרך הגדרות הדפדפן.
      </p>

      <h2 style={h2Style}>8. אבטחת מידע</h2>
      <p>
      ...
      <h2 style={h2Style}>9. שמירת מידע ומחיקתו</h2>
      <table style={tableStyle}>
        <thead>
          <tr>
            <Th>סוג מידע</Th>
      ...
      <h2 style={h2Style}>10. זכויותייך</h2>
      ...
      <h2 style={h2Style}>11. הודעות ודיוור</h2>
      <p>
      ...
      <h2 style={h2Style}>14. יצירת קשר</h2>
